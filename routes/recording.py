...
def record_start(vv_instance):
    ...
    return jsonify(success_response({"result": result}, "RecordStart command executed"))
...
def record_stop(vv_instance):
    ...
    return jsonify(success_response({"result": result}, "RecordStop command executed"))
...
def record_pause(vv_instance):
    ...
    return jsonify(success_response({"result": result}, "RecordPause command executed"))
...
def record_get_filename(vv_instance):
    ...
    return jsonify(
        success_response({"result": result, "executed": True}, f"RecordGetFilename executed successfully: {result}")
    )
