...
def get_hardware_input_channels(vv_instance: Any) -> Response:
    ...
    return jsonify(success_response({"result": result}, f"Hardware input channels: {result}"))
...
def get_hardware_output_channels(vv_instance: Any) -> Response:
    ...
    return jsonify(success_response({"result": result}, f"Hardware output channels: {result}"))
...
def get_hardware_serial_number(vv_instance: Any) -> Response:
    ...
    return jsonify(success_response({"result": result}, f"Hardware serial number: {result}"))
...
def get_software_version(vv_instance: Any) -> Response:
    ...
    return jsonify(success_response({"result": result}, f"Software version: {result}"))
