...
VVIEW_E_LENGTH_MISMATCH = -2147220968          # 0x80040218  # Only raised by COM methods not exposed by this API
...
# VibrationVIEW Informational Codes (SEVERITY_SUCCESS, FACILITY_ITF)
